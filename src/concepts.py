...
class ConceptPooler:
    ...
    def __init__(self,similarity_model_name:str="all-MiniLM-L6-v2",similarity_threshold:float=0.95):
        self.similarity_model = SimilarityModel(similarity_model_name)
